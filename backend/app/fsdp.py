...
FACULTY_KEYWORDS = ("faculty", "instructor", "professor", "lecturer", "teacher", "dean")


def personnel_type(rank: str | None) -> str:
    rank_value = (rank or "").lower()
    return "Faculty" if any(keyword in rank_value for keyword in FACULTY_KEYWORDS) else "Staff"
